...
.equ _COMM_PAGE_START_ADDRESS, 0x00007fffffe00000
.equ _COMM_PAGE_TIME_DATA_START, _COMM_PAGE_START_ADDRESS + 0x050

.equ _NT_TSC_BASE,   0
.equ _NT_SCALE,      8
.equ _NT_SHIFT,      12
.equ _NT_NS_BASE,    16
.equ _NT_GENERATION, 24

	.globl	_mach_absolute_time
_mach_absolute_time:
	pushq	%rbp				// set up a frame for backtraces
	movq	%rsp,%rbp
	movabsq	$(_COMM_PAGE_TIME_DATA_START),%rsi
1:
